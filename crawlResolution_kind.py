...
from sql import resolution_mst_ins, isa_mst_ins, isa_car_ins, isa_dup_ins, biz_ins
...
# html 파일 저장
def get_html(rcp_no):
    url = 'http://kind.krx.co.kr/common/disclsviewer.do?method=search&acptno={0}&docno=&viewerhost=&viewerport='.format(rcp_no)
